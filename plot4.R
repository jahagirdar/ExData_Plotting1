...
# Plot 3
with (data,plot(x=datetime,y=as.numeric(Sub_metering_3),type="n"))
...
par(mfrow=c(2,2))
#Plot 1
with (data,plot(x=datetime,y=as.numeric(Global_active_power),type="n"))
with (data,lines(x=datetime,y=as.numeric(Global_active_power)))
#Plot 2
with (data,plot(x=datetime,y=as.numeric(Voltage),type="n"))
with (data,lines(x=datetime,y=as.numeric(Voltage)))
...
with (data,lines(x=datetime,y=as.numeric(Sub_metering_3),col="blue"))
#Plot 4
with (data,plot(x=datetime,y=as.numeric(Global_reactive_power),type="n"))
with (data,lines(x=datetime,y=as.numeric(Global_reactive_power)))
